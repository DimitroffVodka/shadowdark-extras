...
- **Stat damage in the Effects library.** *STR damage* through *CHA damage* each take 1 point off an ability until healed. Drop one on a character, or into a weapon's on-hit effects or an NPC Activity, which now accept Effects library entries and put them on the target as they are. With Shadowdark Enhancer installed they are its tracked stat damage, which a rest heals. ([#148](https://github.com/DimitroffVodka/shadowdark-extras/issues/148))
